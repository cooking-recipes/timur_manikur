...
<div class="container">
	...
	<div itemscope itemtype="http://schema.org/Product" id="content" class="<?php echo $content_width; ?> product_page"><?php echo $content_top; ?>
			...
			<div class="<?php echo $content_left; ?> product_page-left">				
				...
				<div id="default_gallery" class="product-gallery">
					<?php if ($thumb || $images) { ?>
								...
								<ul id="image-additional"> 
									...
									<li>
										<a href="#" data-image="<?php echo $thumb; ?>" data-zoom-image="<?php echo $popup; ?>">
											<img itemprop="image" src="<?php echo $thumb; ?>" alt="<?=$heading_title?>" />
										</a>
									</li>
									<?php } ?>
									<?php $i = 1; ?>
									...
									<?php $i++; ?>
									<li>
										<a href="#" data-image="<?php echo $image['popup']; ?>" data-zoom-image="<?php echo $image['popup']; ?>"> <img src="<?php echo $image['thumb']; ?>" alt="<?=$heading_title.' (фото №'.$i.')'?>" /> </a>
									</li>
									<?php } ?>
							...
							<?php if ($thumb) { ?>
								<div class="image">
									<img itemprop="image" id="gallery_zoom" src="<?php echo $thumb; ?>" data-zoom-image="<?php echo $popup; ?>" alt="<?=$heading_title.' (фото №'.$i.')'?>" />
								</div>
							<?php } ?>
					<?php } ?>
				</div>
				...
				<div id="full_gallery">
					<ul id="gallery">
						<?php if (!empty($thumb)) { ?><li><a href="<?php echo $popup; ?>" data-something="something" data-another-thing="anotherthing"><img src="<?php echo $popup; ?>" title="<?php echo $custom_imgtitle; ?>" alt="<?php echo $custom_alt; ?>" /></a></li><?php } ?>
						<?php $i = 1; ?>
						<?php foreach ($images as $image) { ?>
						<?php $i++; ?>
						<li><a href="<?php echo $image['popup']; ?>" data-something="something<?php echo $i?>" data-another-thing="anotherthing<?php echo $i?>"><img src="<?php echo $image['popup']; ?>" alt="<?=$heading_title.' (фото №'.$i.')'?>" /></a></li>
							<?php } ?>
					</ul>			
				</div>
				<?php } ?>				
					...
					<div class="price-section" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
						...
						<span	class="price-new">
							<?php
							 ...
							 {
							 	?>
								<meta itemprop="price" content="<?=$parr[0]?>">
		...
		<!-- Product description -->
		<div id="tab-description" class="product-desc product-section" itemprop="description">
